...
-(void)composeInterface {
    ...
    if (_captureManager) {
        ...
        _cameraShutter.frame = CGRectMake(0,0, shutterButtonSize.width, shutterButtonSize.height);
    ...
    if (_topBarView) {
        ...
        _topBarView.frame  = CGRectMake(0,0, topBarSize.width, topBarSize.height);
        ...
        if (_cameraFlash) {
            _cameraFlash.frame = CGRectMake(0,0, barButtonItemSize.width, barButtonItemSize.height);
        ...
        if (_cameraToggle) {
            _cameraToggle.frame = CGRectMake(0,0, barButtonItemSize.width, barButtonItemSize.height);
        ...
        if (_cameraDismiss) {
            _cameraDismiss.frame = CGRectMake(0,0, barButtonItemSize.width, barButtonItemSize.height);
    ...
    if (_focalReticule) {
        ...
        _focalReticule.frame = CGRectMake(0,0, 60, 60);
